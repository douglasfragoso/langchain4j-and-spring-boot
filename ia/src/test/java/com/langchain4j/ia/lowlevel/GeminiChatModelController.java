...
import com.langchain4j.ia.lowlevel.Gemini.GeminiChatModelController;
import com.langchain4j.ia.lowlevel.Gemini.GeminiConfig;

import dev.langchain4j.model.chat.ChatModel;

@WebMvcTest(GeminiChatModelController.class)
@Import(GeminiConfig.class)
class GeminiChatModelControllerTest {
    ...
    void model_ShouldReturnDefaultResponse_WhenNoMessageProvided() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(get("/gemini/model"))
    ...
    void modelPost_ShouldReturnChatResponse_WhenValidRequest() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(post("/gemini/model")
